...
function PasswordConfigurations({ handleInputChange, characterLength }) {
  return (
    <div className="password-configurations__container">
      ...
      <div className="configuration-input__container">
        ...
        <label className="label__container">
          <span className="label__name">Include Lowercase Letters</span>
          <input
            type="checkbox"
            name="useLowercaseLetters"
            onChange={handleInputChange}
          />
          <span className="checkmark"></span>
        </label>
